...
### 🔗 Encode URL
クリップボードのテキストをURLコンポーネント用にpercent-encodingして、結果をクリップボードに出力します。

### 🔓 Decode URL
クリップボードのpercent-encodedテキストをデコードして、結果をクリップボードに出力します。

### 🧾 Prettify JSON
クリップボードのJSONテキストを読み込み、整形したJSONをクリップボードに出力します。
